...
class Cat {
  ...
  // protected : class 내부 또는 자식클래스에서만 접근 가능
  num1: number = 1;           // 기본적으로 public. 생략 가능
  public num2: number = 2;    // 어디서든 접근 가능
  private num3: number = 3;   // 내부에서만 접근 가능
  protected num4: number = 4; // 상속 관계에서만 접근 가능
}
